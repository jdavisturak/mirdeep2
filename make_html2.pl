...
sub PrintQuantifier{
    ...
    open HTML,">expression_analyses_${time}/expression_${time}.html" or die "cannot create expression_analyses_${time}/expression_${time}.html\n";
    CreateHTML(); ##
...
#            die "$id\t$seq\n";
    ...
    open IN,"<expression_analyses_${time}/mature2hairpin" or die "Error: File expression_analyses_${time}/mature2hairpin not found\n";
    my %hairpin2mature2;
	while(<IN>){
        chomp;
		my @line = split(/\t/);
